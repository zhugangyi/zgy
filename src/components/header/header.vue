<template>
  <div class="header-box" style="width: 100%">
    <el-row type="flex" justify="space-between">
      <el-col :span="8">
        <button class="btn-tool" title="折叠" >
          <i class="el-icon-d-arrow-left"></i>
        </button>
        <button class="btn-tool" title="刷新" >
          <i class="el-icon-refresh"></i>
        </button>
        <button class="btn-tool" title="全屏" >
          <i class="el-icon-rank"></i>
        </button>
        <button class="btn-tool" title="便签" >
      ...
      <el-col :span="8" align="center" class="appTitle">
        <span>资 产 管 理 系 统</span>
      </el-col>
